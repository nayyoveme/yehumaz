...
client.on("ready", async () => {
  ...
  client.user.setActivity(`Kerem damlayı seviore ÜvÜ`, { type: "WATCHING" });
...
//ses
client.on("ready", () => {
  client.channels.cache.get("831250370923069450").join();
})
...
client.on('guildMemberAdd', async (member) => {
  /////////////////////////
     //Kanal Tanımı
     ////////////////////////////////////////
    let viruskanal = client.channels.cache.get("830852491142496286")
  ////////////////////////////////////////
  //Güvenlik TanımlarıS
  ////////////////////////////////////////
  ...
  ////////////////////////////////////////
    ...
    //Kanala Gönderme
    ////////////////////////////////////////
    viruskanal.send(` <@${member.id}>`, hgembed) ;
  })
